...
// Keep the materialized extension as static import-free source. Function#toString
// becomes "[native code]" inside the packaged binary and produces an invalid
// extension precisely in the Worker runtime.
